...
public class ActivityController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Not Found"),
            @ApiResponse(code = 500, message = "Failure")})
    public ActivityEntity updateActivity(@RequestHeader(value = ParamConstants.X_AUTHENTICATED_TOKEN) String token, @RequestBody ActivityUpdateInfo activityUpdateInfo) throws MarsException {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Not Found"),
            @ApiResponse(code = 500, message = "Failure")})
    public ActivityEntity deleteActivity(@RequestHeader(value = ParamConstants.X_AUTHENTICATED_TOKEN) String token, @PathVariable String activityId, HttpServletRequest request) throws MarsException {
        String currentUserId = (String) request.getSession().getAttribute(ParamConstants.CURRENT_USER_ID);
